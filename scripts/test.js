$(document).ready(function(){
  ...
  //for each list item in collapsible, run ajax request to return city weather info 
  //append to that collapsible-body
  ...
  function getWeather(){
    $.ajax({
      ...
      success: function(data){
        ...
        var newDiv = $("<div>").addClass("collapsible-body grey lighten-2").attr("value",location);
